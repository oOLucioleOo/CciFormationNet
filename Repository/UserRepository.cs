...
{
    public class UserRepository : GenericRepository<VideoDBEntities, USER>
    {
        // Get for USER
        ...
        public USER GetUserByLoginPwd(string UserLogin, string UserPwd)
        {
        ...
        // Add USER
        public void AddUser(string UserLogin, string UserPwd, string UserFirstName, string UserLastname, string UserMail)
        {
            USER user = new USER();
        ...
        // Update USER by ID
        public void UpdateUserById(string UserLogin, string UserPwd, string UserFirstName, string UserLastname, string UserMail)
        {
